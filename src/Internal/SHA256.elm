module Internal.SHA256 exposing (HashResult, hash)
...
blockStep state =
    if state.remaining <= 0 then
        Decode.succeed (Done { h0 = state.h0, h1 = state.h1, h2 = state.h2, h3 = state.h3, h4 = state.h4, h5 = state.h5, h6 = state.h6, h7 = state.h7 })
